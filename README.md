# HclWebApp
HCL Digital Solution

## By: Shrikant Jamkhandi
HCL Digital Solution
# Pre-reques:
---------------
-- Install Java
...
----------------------------------------------------------------------------------------------------------------------------------
 mvn archetype:generate -DgroupId=com.javatpoint -DartifactId=HclWebApp -DarchetypeArtifactId=maven-archetype-webapp -DinteractiveMode=false
 ...
 http://<host-name>:<portnumber>/projectname, for example: http://localhost:8080/HclWebApp
